...
int main() {
  ...
  scrumble(squares, size_x / square_size, size_y / square_size, square_size, &x, &y);
  draw_squares(squares, size_x / square_size, size_y / square_size, square_size, x, y);

  game(squares, size_x / square_size, size_y / square_size, square_size, &x, &y);
